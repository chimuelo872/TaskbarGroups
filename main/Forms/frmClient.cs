namespace TaskbarGroups.Forms
{
    ...
    public partial class frmClient : Form
    {
        ...
        public void Reset()
        {
            pnlLeftColumn.Height = pnlBottomMain.Bottom > Bottom
                ? pnlBottomMain.Bottom
                : RectangleToScreen(ClientRectangle).Height;
        }
        ...
        {
            Process.Start("https://github.com/tjackenpacken/taskbar-groups/releases");
        }
