namespace TaskbarGroups.Classes
{
    ...
    public class IconFactory
    {
        ...
        /// parameter are
        /// portable network graphic files that have a
        /// <see cref="Image.PixelFormat" />
        /// of
        /// <see cref="PixelFormat.Format32bppArgb" />
        /// and where the
        /// width is less than or equal to
        /// <see cref="IconFactory.MaxIconWidth" />
        /// and the
        /// height is less than or equal to
        /// <see cref="MaxIconHeight" />
        /// .
        ...
        private static void ThrowForInvalidPngs(IEnumerable<Bitmap> images)
        {
            foreach (var image in images)
            {
                if (image.PixelFormat != PixelFormat.Format32bppArgb)
                    throw new InvalidOperationException($"Required pixel format is PixelFormat.{PixelFormat.Format32bppArgb.ToString()}.");
